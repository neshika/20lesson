<?php
    ...
    $urls = [
        [
            "ahref" => "img/demo/gallery/21.jpg",  //image_path
            "ahrefmini" => "img/demo/gallery/thumb/21.jpg" //thumb_path
        ],
        [
            "ahref" => "img/demo/gallery/22.jpg",
            "ahrefmini" => "img/demo/gallery/thumb/22.jpg"
        ],
        [
            "ahref" => "img/demo/gallery/23.jpg",
            "ahrefmini" => "img/demo/gallery/thumb/23.jpg"
        ],
        [
            "ahref" => "img/demo/gallery/24.jpg",
            "ahrefmini" => "img/demo/gallery/thumb/24.jpg"
        ],
        [
            "ahref" => "img/demo/gallery/25.jpg",
            "ahrefmini" => "img/demo/gallery/thumb/25.jpg"
        ],
        [
            "ahref" => "img/demo/gallery/26.jpg",
            "ahrefmini" => "img/demo/gallery/thumb/26.jpg"
        ],
        [
            "ahref" => "img/demo/gallery/27.jpg",
            "ahrefmini" => "img/demo/gallery/thumb/27.jpg"
        ]
    ]
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <?php foreach($urls as $url):?>
                                <a class="" href="<?php echo $url['ahref'];?>">
                                    <img class="img-responsive" src="<?php echo $url['ahrefmini'];?>" alt="image">
                                </a>
