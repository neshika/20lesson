<?php
    ...
    $users = [
       ...
       [ 
            ...
            "email" => "oliver.kopyov@smartadminwebapp.com",
            "address" => "15 Charist St, Detroit, MI, 48212, USA",
            "url" => 'img/demo/avatars/avatar-e.png'
                            ...
                            <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                                <div class="d-flex flex-row align-items-center">
                                    <span class="status <?php echo $user['status'];?> mr-3">
                                        <span class="rounded-circle profile-image d-block " style="background-image:url('<?php echo $user['url'];?>'); background-size: cover;"></span>
                                    </span>
