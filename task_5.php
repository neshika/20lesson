                    ...
                    <div class="panel-container show">
                        ...
                        <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                            ...
                            <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                <img src="<?php echo $people['image']?>" alt="<?php echo $people['name'];?>." class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                <div class="ml-2 mr-3">
                                    <h5 class="m-0">
                                    <?php echo $people['name'] . " " . $people['company'];?>
                                        <small class="m-0 fw-300"><?php echo $people['job'];?></small>
                                    </h5>
                                    <a href="https://twitter.com/<?php echo $people['twitter'];?>" class="text-info fs-sm" target="_blank"><?php echo $people['twitter'];?></a> -
                                    <a href="<?php echo $people['email'];?>" class="text-info fs-sm" target="_blank" title="<?php echo $people['name']?>"><i class="fal fa-envelope"></i></a>
                                </div>
                            </div>
